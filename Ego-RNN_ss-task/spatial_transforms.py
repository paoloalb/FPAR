...
# These are the main transformation applied to raw images
# It's the same thing that we made in homework inside the Compose function
# random transformation seems to have a hardcoded probability of 0.5
