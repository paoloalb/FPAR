...
# test of attentionMap with a test image,
# image is transformed to tensor and fed to the model, then from the tensor image, the image and the dimension, attention map is computed
# see attentionMapModel.py !!!!!
